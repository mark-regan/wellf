...
import { CreateRecipeRequest, Ingredient, Instruction, Course } from '@/types';
...
export function CookingAddRecipe() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const recipe = await cookingApi.createRecipe(recipeData);
      navigate(`/cooking/recipes/${recipe.id}`);
    } catch (err) {
    ...
    <CookingLayout>
      <div className="space-y-6 max-w-4xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-display text-2xl font-bold">Add Recipe</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 justify-end">
            ...
            <Button type="submit" className="bg-cooking hover:bg-cooking/90" disabled={loading}>
